...
There are four hours of lectures each week at the
following locations.
...
Shane's section will be delivered primarily using 
hand-drawn lectures in-person.
You will be expected to take notes during these
lectures and study the relevant notes on this
website.
...
Most of the material in Shane's section will be found
found on this website.

Additional `pdf` files will also be made available on
Canvas to help you study for the exam.

## The Website

The following sections provide some information on the
approach taken when designing the website.
...
Content in these sections can be accessed using the navigation bar.
See @sec-search if you want to search the site using keywords.
